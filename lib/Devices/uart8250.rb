...
module System
  ...
  Device(:uart8250) {
    ...
    AbstractMethod(:platformClearConsoleInt)
    ...
    Method(:scheduleIntr, event: Ptr(System.Event())) {
      Let :interval, System.Tick(), ns * 255
    ...
    Register(:lsr, size: 0x1, offset: 0x5) {
      field :dr, 0x0
      field :oe, 0x1
      field :pe, 0x2
      field :fe, 0x3
    ...
    Register(:msr, size: 0x1, offset: 0x6) {
      field :dcts, 0x0
      field :ddsr, 0x1
      field :teri, 0x2
      field :ddcd, 0x3
    ...
    Field(:status, Int())
    Field(:platform, Ptr(System.Platform()))
    Field(:device, Ptr(System.SerialDevice()))
    Field(:txIntrEvent, System.EventFunctionWrapper)
    Field(:rxIntrEvent, System.EventFunctionWrapper)
    Field(:lastTxInt, System.Tick())
  }
